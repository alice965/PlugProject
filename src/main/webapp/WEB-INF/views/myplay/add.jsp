...
<div class="container">
	...
	<div align="center">
	  ...
	  <br>
	  <form class="w3-container" id="form"  action="/myplay/add" method="post" enctype="multipart/form-data">
	    <p>      
		...
		<div style="background-color:white;">
				...
				<label><input class="w3-check gr" type="checkbox" name="genre" value="R&B/Soul">R&B/Soul </label>
