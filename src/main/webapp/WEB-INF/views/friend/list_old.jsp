...
<div class="w3-container">
	...
	<div class="w3-row">
		<div
			...
			onclick="openPage(event, 'flist');" id="f_list">친구 리스트</div>
		<div
			class="w3-third tablink w3-bottombar w3-hover-light-grey w3-padding"
			onclick="openPage(event, 'slist');" id="s_list">보낸 친구 요청</div>
		<div
			class="w3-third tablink w3-bottombar w3-hover-light-grey w3-padding"
			onclick="openPage(event, 'rlist');" id="r_list">받은 친구 요청</div>
	</div>
